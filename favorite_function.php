...
// likeボタンが押されたとき
  if(isset($_GET["favorite_post_id"])){
    // like関数を引っ張ってきている
    favorite($_GET["favorite_post_id"],$_SESSION["id"],$_GET["page"]);
  ...
  function favorite($favorite_post_id,$login_member_id,$page){
    // 関数の中に書く
     require('dbconnect.php');
         // like情報をlikeテーブルに登録
  ...
  function unfavorite($unfavorite_post_id,$login_member_id,$page){
    require('dbconnect.php');
